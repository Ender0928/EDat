...
/**
 * @brief This function checks if the SearchQueue contains a certain element so
 *its not inserted twice
 *
 * @param sq A pointer to the SearchQueue to be printed.
 * @param v void pointer (the target element)
 *
