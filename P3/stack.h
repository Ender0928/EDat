...
/**
 * @brief  This function merges the two stacks in order
 * @param sin1 A pointer to the element to the stack 1
 * @param sin2 A pointer to the element to the stack 2
 * @param sout A pointer to the resulting stack
 * @param f pointer to de function that compares elements
 * @return Upon successful return, these function returns the number of characters writted.
 * The function returns a negative value if there was a problem writing to the file.
 *  */
